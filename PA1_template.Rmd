...
```{r steps histogram, fig.width=10}
...
```{r average activity, fig.width=10}
...
```{r filled steps histogram, fig.width=10}
...
```{r filled steps mean and median}
